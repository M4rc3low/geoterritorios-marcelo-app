...
> O projeto é atualmente JavaScript/JSX. A checagem estática completa de tipos não é tratada como gate obrigatório enquanto os componentes e a camada de dados não tiverem tipagem explícita suficiente. Isso evita um CI artificialmente vermelho e deixa a futura migração de tipos como uma evolução consciente.
...
Este projeto demonstra desenvolvimento web aplicado a um problema real, organização de dados, visualização geográfica, dashboards e práticas de engenharia como **testes estruturais, lint, CI e containerização**.
